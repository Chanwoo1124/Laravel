...
<html lang="en">
    ...
    <footer style="margin-top: 50px; padding: 20px; background-color: #f3f4f6; border-top: 1px solid #e5e7eb;">
        <h3 style="font-weight: bold; margin-bottom: 10px;">🚀 최근 가입한 사용자들</h3>
        
        <ul style="list-style: none; padding: 0;">
            @foreach ($recentUsers as $user)
                <li style="margin-bottom: 5px;">
                    New User: <strong>{{ $user->name }}</strong> 
